...
<head>
    ...
    <script src="ajax/USER/insertuser.js"></script>
    <script src="ajax/USER/getuser.js"></script>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="" data-toggle="modal" data-target="#myModal">New User</a></li>
                        </ol>
                        <div class="container">
                                                    ...
                                                    <div class="col-md-8 col-xs-12">
                                                        <div class="white-box">
                                                            <div class="alert alert-success alert-dismissible" id="successupdate" style="display:none;">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12">
                                                                        <input type="hidden" id="id" name="id" placeholder="Johnathan " class="form-control form-control-line">
                                                                </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Name</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <input type="text" id="mensagem" name="mensagem" placeholder="Mensagem " class="form-control form-control-line">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="example-email" class="col-md-12">Versão</label>
                                                                    <div class="col-md-12">
                                                                        <input id="versao" name="versao" type="text" placeholder="Versão" class="form-control form-control-line" name="example-email">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Password</label>
